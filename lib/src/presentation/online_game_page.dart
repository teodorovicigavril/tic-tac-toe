...
class _OnlineGamePageState extends State<OnlineGamePage> {
  ...
  void dispose() {
    super.dispose();
    _socketMethods
      ..stopUpdateRoomListener()
      ..stopUpdatePlayersStateListener()
      ..stopTappedListener()
      ..stopSetReadyForUserListener();
  }
                                                                ...
                                                                Stack(
                                                                  ...
                                                                  children: <Widget>[
                                                                    ...
                                                                    PlayerTwoOnlineContainer(
                                                                      builder:
                                                                          (BuildContext context, AppUser? playerTwo) {
                                                                ...
                                                                Stack(
                                                                  ...
                                                                  children: <Widget>[
                                                                    ...
                                                                    PlayerOneOnlineContainer(
                                                                      builder:
                                                                          (BuildContext context, AppUser? playerOne) {
                                                                        return PlayerOnePiecesContainer(
                                                                          builder: (
                                                                            BuildContext context,
                                                                            List<int> playerOnePieces,
